		...
		foreach ($keywords as $keyword) {
			...
			if (wp_automatic_trim($keyword) != '') {
				...
				if (count($res) > 0) {
					...
					//if job is expired return false
					if (isset($is_this_an_expired_job) && $is_this_an_expired_job == true) {
						echo '<br>Job expired not posting ... removing this from cache and will try next run ....';
						return false;
					}
