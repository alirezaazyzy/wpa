...
$allowed_tags['Rumble'] =  array(
	array('[item_title]', 'Title of the video'),
	array('[item_description]', 'Description of the video'),
	array('[item_channel_name]', 'Name of the channel'),
	array('[item_channel_link]', 'Link to the channel'),
	array('[item_upvotes]', 'Number of upvotes'),
	array('[item_downvotes]', 'Number of downvotes'),
	array('[item_tags]', 'Tags of the video'),
	array('[item_image]', 'Src link of the video thumbnail'),
	array('[item_upload_date]', 'Date when the video was uploaded'),
	array('[item_embed_url]', 'URL for the video embed'),
	array('[item_embed_iframe]', 'HTML embed code for the video'),
);

$allowed_tags['Medium'] = array(
    array('[item_url]', 'Original Medium post URL'),
    array('[item_id]', 'Unique ID for the Medium post'),
    array('[item_title]', 'Title of the Medium post'),
    array('[item_author]', 'Author of the Medium post'),
    array('[item_image]', 'Featured image URL of the Medium post'),
    array('[item_description]', 'Full HTML description/content of the Medium post'),
    array('[item_likes]', 'Number of claps/likes on the Medium post'),
    array('[item_story_read_time]', 'Estimated reading time of the Medium post'),
    array('[item_tags]', 'Comma-separated tags of the Medium post')
);
...
if (count($res) > 0) {
	...
	//if is null, set to empty array
	if (is_null($camp_options)) {
		$camp_options = array();
	}
...
[ad_2]';
	...
	//if wp_automatic_openrouter_key and wp_automatic_openai_key are empty and wp_automatic_gemini_key is not empty
	if (trim(get_option('wp_automatic_openrouter_key', '')) == '' && trim(get_option('wp_automatic_openai_key', '')) == '' && trim(get_option('wp_automatic_gemini_key', '') != '')) {
		$camp_general['cg_openai_provider'] = 'google_gemini';
	}
			...
			<div class="contains">
				...
				<div id="field-camp_type-container" class="field f_100" style="margin-top:10px">
					...
					<select <?php if (count($raw_res) != 0)   echo 'disabled="disabled"' ?> name="camp_type" id="camp_type">
						...
						<option value="GoogleTrends" <?php @wp_automatic_opt_selected('GoogleTrends', $camp_type) ?>>Google Trends</option>
						<option value="Medium" <?php @wp_automatic_opt_selected('Medium', $camp_type) ?>>Medium.com</option>
						...
						<option value="Twitter" <?php @wp_automatic_opt_selected('Twitter', $camp_type) ?>>Twitter/x.com</option>
				...
				<div id="field111-container" class="field typepart Articles gpt3 ArticlesBase Amazon Clickbank Youtube Vimeo Flicker  eBay f_100 Pinterest Instagram Twitter SoundCloud Itunes Envato DailyMotion Walmart Careerjet TikTok Aliexpress Places BingNews" style="display:none;">
					...
					<div class="typepart Twitter field f_100">
						...
						<table>
							<thead>
								<tr>
									<td colspan="2"><strong><u>Twitter Keywords Examples..</u></strong></td>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td>from:alexiskold</td>
									<td><i> Tweets from person “alexiskold”.</i></td>
								</tr>
								<tr>
									<td>to:techcrunch</td>
									<td><i> sent to person “techcrunch”.</i></td>
								</tr>
								<tr>
									<td>watching now</td>
									<td><i> containing both “watching” and “now”. This is the default operator.</i></td>
								</tr>
								<tr>
									<td>“happy hour”</td>
									<td><i> containing the exact phrase “happy hour”.</i></td>
								</tr>
								<tr>
									<td>love OR hate</td>
									<td><i> containing either “love” or “hate” (or both).</i></td>
								</tr>
								<tr>
									<td>beer -root</td>
									<td><i> containing “beer” but not “root”.</i></td>
								</tr>
								<tr>
									<td>#haiku</td>
									<td><i> containing the hashtag “haiku”.</i></td>
								</tr>
								<tr>
									<td>@mashable</td>
									<td><i> referencing person “mashable”.</i></td>
								</tr>
								<tr>
									<td>movie -scary :)</td>
									<td><i> containing “movie”, but not “scary”, and with a positive attitude.</i></td>
								</tr>
								<tr>
									<td>flight :(</td>
									<td><i> containing “flight” and with a negative attitude.</i></td>
								</tr>
								<tr>
									<td>traffic ?</td>
									<td><i> containing “traffic” and asking a question.</i></td>
								</tr>
								<tr>
									<td>hilarious has:links</td>
									<td><i> containing “hilarious” and linking to URL.</i></td>
								</tr>
								<tr>
									<td>puppy has:media </td>
									<td><i> containing “puppy” and an image or video.</i></td>
								</tr>
								<tr>
									<td>puppy filter:images</td>
									<td><i> containing “puppy” and links identified as photos, including third parties such as Instagram.</i></td>
								</tr>
								<tr>
									<td>puppy filter:videos </td>
									<td><i> containing “puppy” and a video</i></td>
								</tr>
								<tr>
									<td>puppy filter:links </td>
									<td><i> containing “puppy” and links identified as articles</i></td>
								</tr>
								<tr>
									<td>puppy lang:en </td>
									<td><i> containing “puppy” and in English</i></td>
								</tr>
							</tbody>
						</table>
				...
				<!-- Feed part -->
				<div class="field f_100 typepart Feeds GoogleNews GoogleTrends" style="display:none;">
					<label for="field11">
					...
					<div class="description typepart GoogleTrends" style="display:none;">
						Example:<br>
					...
					<!-- Random feed checkbox -->
					<div class="option clearfix">
						<input name="camp_options[]" value="OPT_RANDOM_FEEDS" type="checkbox">
						<span class="option-title">
							Randomize feeds ( Tick to post from a random feed each time )
						</span>
						<br>
					</div>
				...
				<div id="feed_postcont" class="field f_100 typepart Feeds Multi BingNews GoogleNews GoogleTrends">
						...
						<div class="option clearfix">
							...
							<div id="feed_custom_c" class="select_control_div_div cg_feed_extraction_method cg_feed_extraction_method_css field f_100">
								...
								<table>
									...
									<tr>
										<td style="padding-top:20px" colspan="6">If using XPath and the part you picked is a link and you just want the URL, append this to the end of the XPath /@href so for example instead of "/html/body/div[1]/div[1]/div[3]/a", modify it to be "/html/body/div[1]/div[1]/div[3]/a/@href"</td>
									</tr>
									<tr>
										<td style="padding-top:20px" colspan="6">For each extraction rule, a new tag will be available for you to use on the <b>post template</b> or custom fields section below. It returns the extracted content. <br>For example, the first part you extract using the first rule will have tag named [rule_1] and the second part will have a tag named [rule_2]</td>
									</tr>
						...
						<div class="option clearfix">
							...
							<div id="feed_custom_r" class="select_control_div_div cg_feed_extraction_method cg_feed_extraction_method_regex field f_100">
								...
								<table>
									...
									<tr>
										<td style="padding-top:20px" colspan="5">If you want to extract content between two unique texts in the content use this <strong>startTextHere(.*?)endTextHere</strong> where startTextHere is the unique text that the plugin will extract starting after and endTextHere is the unique text that the plugin will stop once found. The extracted part must be wraped by brackets<br><br>Example: source content contains this html<br> &lt;span class=&quot;author&quot;&gt;Mo Atef&lt;/span&gt; <br>and we want to grab the author name "Mo Atef", we can use this Regex<br> &lt;span class=&quot;author&quot;&gt;(.*?)&lt;/span&gt;</td>
									</tr>
									<tr>
										<td style="padding-top:20px" colspan="5">For each Regex rule, a new tag will be available for you to use on the <b>post template</b> or custom fields section below. It returns the extracted content. <br>For example, the first part you extract using the first rule will have tag named [rule_1] and the second part will have a tag named [rule_2]</td>
									</tr>
									<tr>
										<td style="padding-top:20px" colspan="5">Tick the checkbox if you want the a single match only </td>
									</tr>
								</table>
							...
							<div id="wp_auatomatic_multi_paged_part" class="field f_100">
								...
								<div class="description">
									...
									<p>
										...
										<br><br>Limit: the plugin will load a maximum of 10 pages, concat them together for extraction and applying the content extraction rules, best extraction method will be using CSS Class
									</p>
				...
				<div id="feed_postcont" class="field f_100 typepart Feeds Multi Single BingNews GoogleNews GoogleTrends" style="display:none;">
				...
				<div id="feed_postcont" class="field f_100 typepart Feeds Multi BingNews GoogleNews GoogleTrends" style="display:none;">
				...
				<div class="field f_100 typepart Aliexpress" style="display:none">
					...
					<div class="option clearfix">
						...
						<div id="ali_custom_cur" class="field f_100">
							...
							<div class="description">ex: write USD for United states $ or EUR for euro<br><br>USD, GBP, CAD, EUR, UAH, MXN, TRY, RUB, BRL, AUD, INR, JPY, IDR, SEK,KRW,ILS,THB,CLP,VND</div>
					...
					<div class="option clearfix">
						...
						<div id="ali_custom_lang" class="field f_100">
							...
							<input type="text" placeholder="EN" name="cg_ae_custom_lang" value="<?php echo @$camp_general['cg_ae_custom_lang']  ?>">
							<div class="description">ex: write EN for English<br><br>EN,RU,PT,ES,FR,ID,IT,TH,JA,AR,VI,TR,DE,HE,KO,NL,PL,MX,CL,IN<br></div>
					...
					<div class="option clearfix">
						...
						<input name="camp_options[]" data-controls="ali_custom_min_price" value="OPT_ALIEXPRESS_MIN_PRICE" type="checkbox">
						<span class="option-title">
							Set a minimum sale price
						</span>
						<br>

						<div id="ali_custom_min_price" class="field f_100">
							<label>
								Minimum price
							</label>
							<input type="text" placeholder="100" name="cg_ae_custom_min_price" value="<?php echo @$camp_general['cg_ae_custom_min_price']  ?>">
							<div class="description">in cents ex: write 10000 for $100</div>
						</div>
					</div>

					<!-- set maximum sale price -->
					<div class="option clearfix">

						<input name="camp_options[]" data-controls="ali_custom_max_price" value="OPT_ALIEXPRESS_MAX_PRICE" type="checkbox">
						<span class="option-title">
							Set a maximum sale price
						</span>
						<br>

						<div id="ali_custom_max_price" class="field f_100">
							<label>
								Maximum price
							</label>
							<input type="text" placeholder="200" name="cg_ae_custom_max_price" value="<?php echo @$camp_general['cg_ae_custom_max_price']  ?>">
							<div class="description">ex: write 20000 for $200</div>
						</div>
					</div>

					<!-- Sorting order select sort by:SALE_PRICE_ASC, SALE_PRICE_DESC, LAST_VOLUME_ASC, LAST_VOLUME_DESC-->
					<div class="option clearfix field f_100">
						
						<input name="camp_options[]" data-controls="ali_custom_sort" value="OPT_ALIEXPRESS_SORT" type="checkbox">
						<span class="option-title">
							Sort search results by
						</span>
						<br>

						<div id="ali_custom_sort" class="field f_100">
							<label>Sorting order</label>
							<select name="cg_ae_custom_sort">

								<option value="BEST_MATCH" <?php @wp_automatic_opt_selected('BEST_MATCH', $camp_general['cg_ae_custom_sort']) ?>>Best Match</option>
								<option value="SALE_PRICE_ASC" <?php @wp_automatic_opt_selected('SALE_PRICE_ASC', $camp_general['cg_ae_custom_sort']) ?>>Price: Low to High</option>
								<option value="SALE_PRICE_DESC" <?php @wp_automatic_opt_selected('SALE_PRICE_DESC', $camp_general['cg_ae_custom_sort']) ?>>Price: High to Low</option>
								<option value="LAST_VOLUME_DESC" <?php @wp_automatic_opt_selected('LAST_VOLUME_DESC', $camp_general['cg_ae_custom_sort']) ?>>Orders</option>
								<option value="REVIEW_RATING_DESC" <?php @wp_automatic_opt_selected('REVIEW_RATING_DESC', $camp_general['cg_ae_custom_sort']) ?>>Rating</option>
								<option value="NEWEST" <?php @wp_automatic_opt_selected('NEWEST', $camp_general['cg_ae_custom_sort']) ?>>Newest</option>
				...
				<div class="field  typepart Rumble" style="display:none">
					...
					<div class="field f_100">
						...
						<div class="option clearfix">
							<input name="camp_options[]" value="OPT_RM_CACHE" type="checkbox">
							<span class="option-title">Cache items for faster posting (uncheck to call Rumble each post) (pagination will not work if disabled)</span>
							<br>
						</div>

						<!-- Add posts with its original time -->
						<div class="option clearfix">
							<input name="camp_options[]" value="OPT_RM_TIME" type="checkbox">
							<span class="option-title">Add posts with its original posting time on Rumble</span>
							<br>
						</div>

						<!-- Add original tags as post tags -->
						<div class="option clearfix">
							<input name="camp_options[]" value="OPT_RM_TAGS" type="checkbox">
							<span class="option-title">Add original tags as post tags</span>
							<br>
						</div>
				...
				<div class="field  typepart telegram" style="display:none">
					...
					<div class="field f_100">
						...
						<!-- skip replies posts -->
						<div class="option clearfix">
							<input name="camp_options[]" value="OPT_CL_SKIP_REPLIES" type="checkbox">
							<span class="option-title">
								Skip replies posts
							</span>
							<br>
				...
				<!-- Medium part -->
				<div class="field f_100 typepart Medium" style="display:none">

					<!-- Medium.com type of posting by tag,search or user -->
					<div class="option clearfix">
						<label>Medium.com type of posting</label><br>
						<select name="cg_md_type">
							<option  value="tag" <?php @wp_automatic_opt_selected('tag', $camp_general['cg_md_type']) ?>>By Tag</option>
							<option  value="search" <?php @wp_automatic_opt_selected('search', $camp_general['cg_md_type']) ?>>By Search</option>
							<option  value="user" <?php @wp_automatic_opt_selected('user', $camp_general['cg_md_type']) ?>>By User</option>
						</select>
					...
					<label>
						Medium.com items page url (must display Medium posts)
					</label>

					<input value="<?php echo @$camp_general['cg_md_page']  ?>" name="cg_md_page" type="text">
					<div class="description">*Without any parameters<br><br>example:<br><br> https://medium.com/tag/ai<br>https://medium.com/@samuelap1<br>https://medium.com/search?q=ai</div>
					<br>

					<!-- Cache items for faster posting -->
					<div class="option clearfix">
						<input name="camp_options[]" value="OPT_MD_CACHE" type="checkbox">
						<span class="option-title">
							Cache items for faster posting (uncheck to call Medium each post) (pagination will not work if disabled)
						</span>
						<br>
					</div>

					<!-- set original tags as post tags -->
					<div class="option clearfix">
						<input name="camp_options[]" value="OPT_MD_TAGS" type="checkbox">
						<span class="option-title">
							Set original tags as post tags	
						</span>
						<br>	
					...
					<!-- original author as post author -->
					<div class="option clearfix">
						<input name="camp_options[]" value="OPT_MD_AUTHOR" type="checkbox">
						<span class="option-title">
							Set the post author from the original post author
						</span>
						<br>	
				...
				<div class="field f_100 typepart Facebook" style="display:none">
					...
					<label>
						Facebook Page/Public Profile url or Numeric ID
					</label>
				...
				<div id="field1zz-container" class="typepart Amazon" style="display:none">
					...
					<div class="field f_100">
						...
						<select data-filters="#field_amazon_cat" name="camp_amazon_region" id="field1zzg">
							...
							<option value="com.be" <?php @wp_automatic_opt_selected('com.be', $camp_amazon_region) ?>>amazon.com.be</option>
						</select>
					</div>
					...
					<div>
						...
						<!-- custom amazon associate tag -->
						<div class="field f_100">
							<div class="option clearfix">
								<input name="camp_options[]" data-controls="am_associate_tag" value="OPT_AM_ASSOCIATE_TAG" type="checkbox">
								<span class="option-title">
									Use a custom amazon associate tag (if you have one)
								</span>
								<br>		
								<div id="am_associate_tag" class="field f_100">
									<label>
										Associate tag
									</label>
									<input value="<?php echo @$camp_general['cg_am_associate_tag']  ?>" name="cg_am_associate_tag" type="text">
									<div class="description">*This is your amazon associate tag, if you have one<br><br>Example: if your associate tag is "mytag-20" then the link
									will be like this: https://www.amazon.com/dp/B00X4WHP5E?tag=mytag-20<br><br>**If you do not have one, leave it empty and the plugin will use the default one that you added to the plugin settings page</div>
								</div>
							</div>
						</div>
						...
						?>
							...
							<!-- original brand as brand -->
							<div class="field f_100">
								<div class="option clearfix">
									<input name="camp_options[]" value="OPT_AMAZON_BRAND" type="checkbox">
									<span class="option-title">
										Set the WooCommerce product brand from the original product brand
									</span>
									<br>
								</div>
							</div>
							...
							<div class="field f_100">
								<div class="option clearfix">
									<input name="camp_options[]" value="OPT_AMAZON_ASIN" type="checkbox">
									<span class="option-title">
										Set the WooCommerce product ASIN as SKU
									</span>
									<br>
								</div>
							</div>

							<!-- product technical details as product attributes -->
							<div class="field f_100">
								<div class="option clearfix">
									<input name="camp_options[]" value="OPT_AMAZON_TECH" type="checkbox">
									<span class="option-title">
										Set the product technical details as WooCommerce product attributes
									</span>
									<br>
								</div>
							</div>	
				...
				<div id="yt_date_div" class="typepart Youtube Feeds Multi BingNews GoogleNews GoogleTrends Instagram Facebook Twitter SoundCloud DailyMotion telegram field f_100">
					<div class="option clearfix">
				...
				<div class="typepart gpt3" style="display:none">
					...
					<div class="field f_100">
						...
						<div id="article_generation_prompt_cnt" class="field  ">
							...
							<textarea name="cg_gp_prompt" placeholder="<?php echo WPAUTOMATIC_DEFAULT_ARTICLE_PROMPT ?>"><?php echo wp_automatic_htmlentities(@$camp_general['cg_gp_prompt'], ENT_COMPAT, 'UTF-8')   ?></textarea>
				...
				<div class="typepart Twitter">
					...
					<!-- Select box search type Top,Latest -->
					<div class=" f_100">
						<label for="cg_tw_search_type">Search Type</label>
						<select id="cg_tw_search_type" name="cg_tw_search_type">
							<option value="Latest" <?php @wp_automatic_opt_selected('Latest', $camp_general['cg_tw_search_type']) ?>>Latest</option>
							<option value="Top" <?php @wp_automatic_opt_selected('Top', $camp_general['cg_tw_search_type']) ?>>Top</option>
				...
				<div class="typepart Youtube" style="display:none">
					...
					<div class="field f_100">
						...
						<div class="option clearfix">
							...
							<span class="option-title">
								Post currently live videos only
							</span>
							<br>
						</div>
						...
						<div class="option clearfix">
							<input name="camp_options[]" value="OPT_YT_LIVE_COMPLETED" type="checkbox">
							<span class="option-title">
								Post completed live videos only
							</span>
							<br>
						</div>
						...
						<!-- Checkbox set the post to pending if the transcript was not found -->
						<div class="option clearfix">
							<input name="camp_options[]" value="OPT_YT_NO_TRAN_PENDING" type="checkbox">
							<span class="option-title">
								Set the post to pending if the transcript was not found
							</span>
						</div>
				...
				<div id="postTemplates" style="display:none">
								...
								//require file p_templates.php
								//file exists in the same directory as this file
								if (file_exists(plugin_dir_path(__FILE__) . 'p_templates.php')) {
									require_once(plugin_dir_path(__FILE__) . 'p_templates.php');
								} else {
									echo '<div class="error">Error: p_templates.php file not found</div>';
								}
								?>
