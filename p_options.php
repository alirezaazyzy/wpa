						...
						<div style="min-height: 1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
								...
								<div class="inside main" style="padding-bottom: 14px">
									...
									<div class="TTWForm">
										...
										<div class="field f_100  ">
										 ...
										 <!-- Prices decimal seprator default to . -->
										<div class="field f_100  ">
											<label> Desired decimal separator for prices </label>
											<input value="<?php   echo get_option( 'wp_automatic_amazon_price_decimal' , '' ) ?>" name="wp_automatic_amazon_price_decimal" type="text">
											<div class="description">Set as "." without quotes or "," without quotes</div>
										</div>

										<div class="field f_100  ">
											<label> Desired thousands separator for prices </label>
											<input value="<?php   echo get_option( 'wp_automatic_amazon_price_thousands' , '' ) ?>" name="wp_automatic_amazon_price_thousands" type="text">
										</div>
										...
										<div class="field f_100">
											<div class="option clearfix">
												...
												<div class="field f_100">
													...
													<!-- hint: must setup an external cron job https://valvepress.com/how-to-update-amazon-products-prices-imported-automatically-using-wordpress-automatic-plugin/ -->
													<div class="description">	
														*Note: You must setup an external cron job for price updates to work <br> <br>*Check <a href="https://valvepress.com/how-to-update-amazon-products-prices-imported-automatically-using-wordpress-automatic-plugin/" target="_blank">this tutorial</a> 
													</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<!-- app id -->
									<div class="field f_100 ">
										<p>Check this <a target="_blank" href="https://valvepress.com/how-to-create-aliexpress-app-key-and-secret-code/">tutorial</a> on how to create an AliExpress app key and secret code</p>
										<label for="field285"> AppKey  </label> <input value="<?php   echo get_option( 'wp_automatic_ali_app_id' ) ?>" name="wp_automatic_ali_app_id" id="field285" type="text">
									</div>

									<!-- app secret -->
									<div class="field f_100 ">
										<label for="field285"> App Secret  </label> <input value="<?php   echo get_option( 'wp_automatic_ali_app_secret' ) ?>" name="wp_automatic_ali_app_secret" id="field285" type="text">
									</div>

									<!-- tracking id optional -->
									<div class="field f_100 ">
										<label for="field285"> Tracking ID (optional) </label> <input value="<?php   echo get_option( 'wp_automatic_ali_tracking_id' ) ?>" name="wp_automatic_ali_tracking_id" id="field285" type="text">
										<div class="description">Your tracking ID for affiliate earnings from AliExpress</div>
									</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										...
										<textarea name ="wp_automatic_x_rapid_token"   type="text"><?php   echo get_option( 'wp_automatic_x_rapid_token' ) ?></textarea>
										
										<div class="description">
											
										*Click <a href="https://rapidapi.com/alexanderxbx/api/twitter-api45" target="_blank">here</a> to apply for the API and get the token<br><br>  *Check <a href="https://valvepress.com/how-to-generate-x-com-api-token-to-post-from-x-to-wordpress-automatically/" target="_blank">this tutorial</a> on how to get the bearer token<br><br>*You can add many tokens from different accounts one per line and the plugin will rotate using them
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100">
										<div class="option clearfix">
											<input name="wp_automatic_options[]" <?php   echo cchecked('wp_automatic_options', 'OPT_OPENAI_WEB_SEARCH')  ?> value="OPT_OPENAI_WEB_SEARCH" type="checkbox"> <span class="option-title">Force enable OpenAI web search on all campaigns</span>
										</div>
										<div class="description">
											*This option will enable the plugin to use OpenAI web search to get the latest information from the internet<br><br>*This option is increase the cost of the API so use it only if you need updated information from the internet for your prompts<br><br>*Enabling this option will enable the web search on all campaigns that use OpenAI API, you can disable it and enable the same option on specific campaigns from the campaign settings page
										</div>
									</div>
									...
									<div class="field f_100 ">
										<label>Default search country (optional)</label> <input value="<?php   echo get_option( 'wp_automatic_openai_country' ) ?>" name="wp_automatic_openai_country" type="text">
										<div class="description">
											*The default country to use if no country is specified in the campaign so the model can search the internet from this country and the results should be relevant to this country<br><br>Example: "US" for United States, "GB" for United Kingdom, "CA" for Canada<br><br>*If left empty, the plugin will use the default country of the OpenAI model which is "us"
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								<h2 class="hndle"> <img class="wp_automatic_box_icon" src="<?php   echo plugins_url('images/gemini.png',__FILE__)?>"><span> Google Gemini API Key</span> </h2>
								<div class="inside TTWForm main" style="padding-bottom: 14px"> <!--start container-->
									<div class="field f_100 ">
										<label>Google Gemini API Key</label> 
										<textarea name="wp_automatic_gemini_key"><?php   echo get_option( 'wp_automatic_gemini_key' ) ?></textarea>
										<div class="description">
											*Check <a href="https://valvepress.com/how-to-create-google-gemini-api-key/" target="_blank">this tutorial</a> on how to get your API token
											<br><br>*You can add a single key or a list of keys(one per line) for the plugin to rotate between them
										</div>

										<!-- default model defaults to -->
										<div class="field ">
											<label>Default model (optional)</label> <input placeholder="<?php echo WPAUTOMATIC_GEMINI_MODEL ?>" value="<?php   echo get_option( 'wp_automatic_gemini_model', WPAUTOMATIC_GEMINI_MODEL ) ?>" name="wp_automatic_gemini_model" type="text">
											<div class="description">
												*The default model to use if no model is specified in the campaign. <br><br>*Check <a href="https://ai.google.dev/gemini-api/docs/models" target="_blank">Gemini models</a> for available models. e.g: gemini-2.0-flash	<br><br>*If left empty, the plugin will use the model "<?php echo WPAUTOMATIC_GEMINI_MODEL ?>"
											</div>
										</div>
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px"> <!--start container-->
									...
									<!-- default model -->
									<div class="field f_100 ">
										<label>Default model (optional)</label> <input value="<?php   echo get_option( 'wp_automatic_openrouter_model', WPAUTOMATIC_OPENROUTER_MODEL ) ?>" name="wp_automatic_openrouter_model" type="text">
										<div class="description">
											*The default model to use if no model is specified in the campaign. <br><br>*Check <a href="https://openrouter.ai/models" target="_blank">OpenRouter models</a> for available models. e.g: google/gemini<br><br>*You can use free models like "<?php echo WPAUTOMATIC_OPENROUTER_MODEL ?>"<br><br>*If left empty, the plugin will use the free model "<?php echo WPAUTOMATIC_OPENROUTER_MODEL ?>"<br><br>*OpenRouter free models are limited to 50 daily requests per account if you did not add credit to your account and to 1000 daily if you added at least 10 credits, check exact limits <a href="https://openrouter.ai/docs/api-reference/limits" target="_blank">here</a>
										</div>
									</div>
						...
						<div style="min-height: 1px;" class="meta-box-sortables ui-sortable" id="normal-sortables">
							...
							<div class="postbox wp_automatic_hide_noactive" id="dashboard_right_now">
								...
								<div class="inside main TTWForm" style="padding-bottom: 14px">
									...
									<!-- Name of the default category for posts for the plugin to remove from added posts -->
									<div class="field f_100 ">
										<label>ID of the Default category to remove from added posts (optional)</label> <input value="<?php   echo get_option( 'wp_automatic_default_cat' ) ?>" name="wp_automatic_default_cat" type="text">
										<div class="description">If you have a category named "Uncategorized" and you want the plugin to remove it from the added posts, add the id of the category here, you can find the id by visiting the category from your dashboard and find the tag_ID= value</div>
									</div>
