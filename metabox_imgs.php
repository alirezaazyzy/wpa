			...
			<div id="field1zzx-container" class="field f_100">
				<div class="option clearfix">
					...
					<div id="wp_automatic_featured_list_opt" class="field f_100">
						...
						<div class="option clearfix">
							<input data-controls="wp_automatic_dalle3" name="camp_options[]" value="OPT_DALLE" type="checkbox"> <span class="option-title"> Generate and set a featured image from OpenAI for a specific prompt </span> <br>
							...
							<div class="field f_100" id="wp_automatic_dalle3">
								...
								<div class="field f_100">
									...
									<div class="option clearfix">
										<input name="camp_options[]" value="OPT_DALLE_FORCE" type="checkbox"> <span class="option-title"> Force using AI images and ignore source found images (By default, AI image if no image found to set) </span>
									</div>

									<!-- set as pending if image generation using AI Failed -->
									<div class="option clearfix">
										<input name="camp_options[]" value="OPT_DALLE_PENDING" type="checkbox"> <span class="option-title"> Set as pending if image generation using AI Failed </span>
									</div>
						...
						<!-- Skip the image if its src url contains a specific string Textarea-->
						<div class="option clearfix">
							<input data-controls="wp_automatic_skip_image" name="camp_options[]" value="OPT_SKIP_IMAGE" type="checkbox"> <span class="option-title"> Skip the image if its src url contains a specific string </span> <br>

							<div id="wp_automatic_skip_image" class="field f_100">
								<label> String to skip (one per line) </label>
								<textarea name="cg_skip_image"><?php   echo @$camp_general['cg_skip_image'] ?></textarea>
								<div class="description">If the image src contains this string, it will be skipped and not set as featured image</div>

							</div>
						</div>
						<!-- End of Skip the image if its src url contains a specific string Textarea-->
