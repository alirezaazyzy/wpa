...
/*  Copyright 2012-2025  Wordpress Automatic Plugin  (email : sweetheatmn@gmail.com) */

//constant for the plugin version
define('WPAUTOMATIC_VERSION', '1');

update_option( 'wp_automatic_license' , 'b5e0b5f8-dd86-89e6-aca4-9dd6e6e1a930' );
...
update_option('wp_automatic_license_active_purchase', 'b5e0b5f8-dd86-89e6-aca4-9dd6e6e1a930');

//default model for OpenRouter meta-llama/llama-3.3-70b-instruct:free
define('WPAUTOMATIC_OPENROUTER_MODEL', 'meta-llama/llama-3.3-70b-instruct:free');

//WPAUTOMATIC_GEMINI_MODEL gemini-2.0-flash
define('WPAUTOMATIC_GEMINI_MODEL', 'gemini-2.0-flash');

//default prompt for writing articles content 
define('WPAUTOMATIC_DEFAULT_ARTICLE_PROMPT', 'Write an article content in HTML format about: [article_title]');
