...
class CampaignProcessor{
	...
	function processCampaign($campaign,$userOrCron = 'User'){
		...
		//GoogleTrends
		}elseif( $camp_type == 'GoogleTrends' ){
			
			require_once 'core.googletrends.php';
			...
			require_once 'core.medium.php';
			
			if(! class_exists('WpAutomaticMedium')) return false;
			
			$WpAutomatic = new WpAutomaticMedium();
